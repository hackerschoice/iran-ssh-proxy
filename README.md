...
5. We have heard that some volunteers are sending us LOGIN + PASSWORD of hacked servers that our (unknowlingly) software than turns into a free proxy for others to use. Is this clever or not? In case you are unsure perhaps better [contact us](https://t.me/+tIblf9hhvBAwOGNk) and we can verify the credentials.
